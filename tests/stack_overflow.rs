...
use oxide::{exit_qemu, QemuExitCode, serial_println, serial_print};
...
lazy_static! {
    static ref TEST_IDT: InterruptDescriptorTable = {
        ...
        unsafe {
            idt.double_fault.set_handler_fn(test_double_fault_handler).set_stack_index(oxide::gdt::DOUBLE_FAULT_IST_INDEX);
        }
        idt
    };
}
